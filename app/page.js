...
export default function Home() {
 ...
 const searchPost = (e) => {
  ...
  return (
    <>
      <main className="container mx-0 px-4 py-6">
        <h2 className="text-4xl font-bold mb-4">Welcome to Our Blog</h2>
        <p>
          Here you can read the latest articles.
        </p>
      </main>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-20">
        ...
        <div className="border border-gray-200 p-4" key={post.image}>
    ...
    {!posts.length > 0 && inputRef.current.value && <p className="ml-4">No posts available for this query: <b>{inputRef.current.value}</b></p>}
    </div>
    </> 
  );
}
